...
.Synopsis
   Get OneDrive Status
.DESCRIPTION
   Get OneDrive Status using the new available API in Windows 11 and some new Windows 11 Versions
.EXAMPLE
   Get-ODStatus
.EXAMPLE
...
#>
    ...
    Start-Process -FilePath $ExeName -Wait -NoNewWindow | Tee-Object -Variable output
    $result = $instances = ConvertFrom-Json -InputObject $output
    return $result
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUeDk172kmWJZw+W8H06/jDnL7
# iJSggiK8MIIEMjCCAxqgAwIBAgIBATANBgkqhkiG9w0BAQUFADB7MQswCQYDVQQG
...
# FGWCWG6T6lcreEVnVmDE7XeYL4mKMA0GCSqGSIb3DQEBAQUABIIBAAc/DIwCr7FM
# PMohr1JWt/KD78riJs7lDeI2m8OEDjYWQCnPsWfbtKkFMXai9EzTlMg3gBX2lGm+
# VzAiEWxqbvDxFqkJJiaKzcGLoLU+Q95VQEW8ylg8jux+u8IbO+3E0o+HDw9i1m0H
# wEfducgc4jzOnVWepDULDNR1p+O7dxyBgXCj5B9q1bINZnwUj0L8elTUJrw/kqG8
# gwliDxVRPAExpfTrYyWnGfO4qXsEU85tSG/eR+1DlkzyeAoF79FQrNMjAofGYDfZ
# 9lvNbWVD0Duo+CJZgLOd5K84A/vxFtuDUs3iYwTMQSVYyc8XnvhVPCFGcbxj15rZ
# iZHgXT8V4B2hggNLMIIDRwYJKoZIhvcNAQkGMYIDODCCAzQCAQEwgZEwfTELMAkG
# A1UEBhMCR0IxGzAZBgNVBAgTEkdyZWF0ZXIgTWFuY2hlc3RlcjEQMA4GA1UEBxMH
...
# CQUxDxcNMjQwMTMwMDAzMzEyWjA/BgkqhkiG9w0BCQQxMgQwjqG9h8GftFa97dLR
# z4SbVRq93U5MpPGlGGha1Rg5HCjYGJm2Qlzg+FKlZjfMTv4bMA0GCSqGSIb3DQEB
# AQUABIICAF7NoyhdFukiLVXZvVr2UUZ2bZmu8fU94959l2qGy8u8pnkRK9aPIFQr
# XonylBJYX1x8iRQiK/aVnG/DJrpRO74/Qk+X+iVCND+gkBdPM7LdPBNZw91EfODF
# TwRO+hQfDf1wN0HDGE9J+t4v6o/K+12H1qUGzdIR4hD0uV1hXyPxd2qa0iWuyzjd
# +OO11aLGKM2FA14RPS0TruS4/irSQSe4SQ/kR+7DFB/gWVvdOIcCkCTmCO5VETBo
# 9Zv/1mk9twv8a53NwDmEPG07nBGkVWOo46iIox5UF3jq+cKyB+EYe3QQp3EvRuQ8
# 6OeeL/5MvDrKJC2IPeIxVFy50cPo3NH9PaJD8W1W/iFuPTRJJzWhhn7EDVsIJcIo
# 1ivw51bpW9ORFRyjy+k/elZT3TIWTvltVIULOD8mOsnBt4sC1wBiY+93NH66ufOa
# uB+4xWAxPGa7MrkCzZz3qvDz5EHaGpy7qI/me8letng07vYiehMebAzunJhNtFi9
# rn3Jf4FxtYJupu+NKdQ1sGmu/cYDeS45YQL3FRIsmZWFeFrmudr5AjXDvh6z60kS
# ph+Gb54CExTqnxhc79wKgv6YAAMFkwhJ0lAbt5GFYBnw46N15NKULy0JAv1zqh9g
# FZ+4IdgV0vkMM0ji6XAbUXvFS9/JE0GrBWWjCECZ8qzLxBtvurjn
